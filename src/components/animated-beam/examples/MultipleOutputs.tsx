...
export const MultipleOutputs = ({ className }: { className?: string }) => {
    ...
    return (
        <div
            className={cn(
                'bg-background relative flex w-full max-w-[500px] items-center justify-center overflow-hidden rounded-lg p-10',
                className
            )}
            ref={containerRef}
        >
