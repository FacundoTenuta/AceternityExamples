...
const InfiniteMovingCardsDemo = () => {
    return (
        <div className='dark:bg-grid-white/[0.05] relative flex h-[40rem] flex-col items-center justify-center overflow-hidden rounded-md bg-transparent antialiased dark:bg-transparent'>
            <InfiniteMovingCards
                items={testimonials}
                direction='right'
                speed='slow'
